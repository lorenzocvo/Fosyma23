...
import eu.su.mas.dedaleEtu.mas.agents.dummies.explo.SiloTankerAgent;
...
//				//4) Give the class name of your agent to let the system instantiate it
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo1={"A2","A3","A4","A5","A6","Tank"};

		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName,ExploreCoopAgent2.class.getName(), entityParametersExplo1);
...
//						
//						//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo2={"A1","A3","A4","A5","A6","Tank"};
//						
//						//4) Give the class name of your agent to let the system instantiate it
		...
		//		
		//		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo3={"A1","A2","A4","A5","A6","Tank"};
		//		
		//		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, ExploreCoopAgent2.class.getName(), entityParametersExplo3);//ExploreSoloAgent
		//		
		agentList.add(ag);
		...
		//
		//		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo4={"A1","A2","A3","A5","A6","Tank"};
		//
		//		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, ExploreCoopAgent2.class.getName(), entityParametersExplo4);//ExploreSoloAgent
		//
		agentList.add(ag);
...
//		 * AGENT Explo5
		...
		//
		//		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo5={"A1","A2","A3","A4","A6","Tank"};
		//
		//		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, ExploreCoopAgent2.class.getName(), entityParametersExplo5);//ExploreSoloAgent
		//
		agentList.add(ag);
...
//		 * AGENT Explo6
		...
		//
		//		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo6={"A1","A2","A3","A4","A5","Tank"};
		//
		//		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, ExploreCoopAgent2.class.getName(), entityParametersExplo6);//ExploreSoloAgent
		//
		agentList.add(ag);	
...
//				agentList.add(ag);
		...
		//		
		//		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersT={"A1","A2","A3","A4","A5","A6"};
		//		
		//		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, SiloTankerAgent.class.getName(), entityParametersT);
		agentList.add(ag);
		//		
